...
//                                        Toast.makeText(registerComplaintPage.this, document.getId() + " => " + document.getData().get("LEFT_VIEW"), Toast.LENGTH_SHORT).show();
                                        ...
                                        Toast.makeText(registerComplaintPage.this, pic1+"::"+pic2+"::"+pic3+"::"+pic4, Toast.LENGTH_LONG).show();
                                    }
                                } else {
    ...
    private void uploadImageToFirebase(String name, Uri contentUri) {
        ...
        image.putFile(contentUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(registerComplaintPage.this, "Image Unavailable. Still Process is Continuing...", Toast.LENGTH_SHORT).show();
            }
        });
...
//                    Toast.makeText(registerComplaintPage.this, "toast2", Toast.LENGTH_SHORT).show();
                    lat = latitude;
                    lng = longitude;
...
//                    Toast.makeText(registerComplaintPage.this, "toast22", Toast.LENGTH_SHORT).show();
                }
...
//        Toast.makeText(registerComplaintPage.this, "toast3", Toast.LENGTH_SHORT).show();
...
//            Toast.makeText(registerComplaintPage.this, "toast4", Toast.LENGTH_SHORT).show();
...
//                Toast.makeText(registerComplaintPage.this, "toast5", Toast.LENGTH_SHORT).show();
                Toast.makeText(registerComplaintPage.this, resultData.getString(Constants.RESULT_DATA_KEY), Toast.LENGTH_SHORT).show();
            }
