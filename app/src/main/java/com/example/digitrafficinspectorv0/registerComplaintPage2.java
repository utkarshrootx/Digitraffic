...
//        int permisI = ContextCompat.checkSelfPermission(registerComplaintPage2.this, Manifest.permission.READ_PHONE_STATE);
//
//        if(permisI == PackageManager.PERMISSION_GRANTED){
//            tm = (TelephonyManager) getSystemService(Context.TELEPHONY_SERVICE);
//            imei = tm.getDeviceId();
//            Toast.makeText(registerComplaintPage2.this,imei, Toast.LENGTH_SHORT).show();
//        }
//        else{
...
//                if (ActivityCompat.checkSelfPermission(registerComplaintPage2.this, Manifest.permission.READ_PHONE_STATE) != PackageManager.PERMISSION_GRANTED) {
//                    ActivityCompat.requestPermissions(registerComplaintPage2.this, new String[]{Manifest.permission.READ_PHONE_STATE}, 101);
//                    return;
//                }
//                imei = telephonyManager.getDeviceId();
                loadingDialogue.startLoadingDialogue();
//                Toast.makeText(registerComplaintPage2.this, pic1 + ":::" + pic2 + ":::" + pic3+":::"+imei , Toast.LENGTH_LONG).show();
    ...
    private void uploadImageToFirebase(String name, Uri contentUri) {
        ...
        image.putFile(contentUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(registerComplaintPage2.this, "Image Unavailable. Still Process is Continuing...", Toast.LENGTH_SHORT).show();
            }
        });
...
//                Toast.makeText(registerComplaintPage2.this, resultData.getString(Constants.RESULT_DATA_KEY), Toast.LENGTH_LONG).show();
